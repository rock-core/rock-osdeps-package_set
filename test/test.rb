...
module Rock
    describe "setup_rock_osdeps" do
        before do
            file = File.join(File.dirname(__FILE__),"..","data","master-18.01-amd64.yml")
        ...
        describe "#initialize" do
            it "initializes the internal structures" do
                assert @ps.pkg_to_deb["base/types"] = "rock-master-18.01-base-types"
                assert @ps.deb_to_pkg["rock-master-18.01-base-types"] = "base/types"
            end
